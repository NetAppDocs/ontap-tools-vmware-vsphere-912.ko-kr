...
* ONTAP System Manager 9.8P1 이상을 사용하여 클러스터 관리자 또는 SVM 관리자 역할을 생성합니다.
을 참조하십시오 link:../configure/task_configure_user_role_and_privileges.html["사용자 역할 및 권한을 구성합니다"] 를 참조하십시오.
