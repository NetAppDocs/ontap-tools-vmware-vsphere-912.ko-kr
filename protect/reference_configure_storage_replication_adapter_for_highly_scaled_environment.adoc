...
의 값을 설정해야 합니다 `storage.commandTimeout` 및 `storage.maxConcurrentCommandCnt` 스케일 수준이 높은 환경의 시간 제한 간격을 99,999초로 설정합니다.
...
https://docs.vmware.com/en/Site-Recovery-Manager/index.html?hWord=N4IghgNiBcIGoFkDuYBOBTABAZQJYBcsAldAYwHsA3dVAT0wTADswBzGzAEXNIFcBbdE3xh8uckxABfIA["VMware Site Recovery Manager 설명서: 스토리지 설정 변경"]
